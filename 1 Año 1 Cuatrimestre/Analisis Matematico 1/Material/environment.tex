...
\newenvironment{property}[2][]{
	...
	{\mdfsetup{
		frametitle={
			\tikz[baseline=(current bounding box.east),outer sep=0pt]
			\node[anchor=east,rectangle,fill=pink!25]
			{\strut };}}
	}
	{\mdfsetup{
		frametitle={
	...
	\mdfsetup{innertopmargin=0pt,linecolor=pink!25,
		linewidth=1pt,topline=true,
		frametitleaboveskip=\dimexpr-\ht\strutbox\relax
	}
	\begin{mdframed}[]\relax
...
\newcommand{\iffbecause}[1] {
	\ensuremath{\overset{#1}{\Leftrightarrow}}
}

\newcommand{\impliesbecause}[1] {
	\ensuremath{\overset{#1}{\Rightarrow}}
}

\newcommand{\lreqn}[2] {
	\noindent\makebox[\linewidth]{$\displaystyle#1$\hfill#2}\vspace{2ex}
}
